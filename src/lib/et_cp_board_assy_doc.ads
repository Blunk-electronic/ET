...
--                             SYSTEM ET                                    --
--                                                                          --
--             COMMAND PROCESSOR / BOARD / ASSEMBLY DOCUMENTATION           --
--                                                                          --
--                               S p e c                                    --
--                                                                          --
...
package et_cp_board_assy_doc is


	-- Parses a command that draws an object in assy doc.
	-- Objects are lines, arcs, circles and zones.
	-- Examples:
