...
package et_cp_schematic_sheet is
	...
	-- This procedure parses a command that adds a sheet:
	-- Example 1: "module demo add sheet"
	-- Example 2: "module demo add sheet development"
	procedure add_sheet (
