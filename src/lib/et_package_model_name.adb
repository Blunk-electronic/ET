...
package body et_package_model_name is
	...
	function to_string (
		...
		return string
	is (pac_package_model_file.to_string (pac_package_model_file.bounded_string (name)));
	...
	is (type_package_model_name (pac_package_model_file.to_bounded_string (name)));
