...
--                              SYSTEM ET                                   --
--                                                                          --
--                    MODULE WRITE / ASSEMBLY DOCUMENTATION                 --
--                                                                          --
--                               B o d y                                    --
--                                                                          --
...
package body et_module_write_assy_doc is
	...
	is
		...
		begin
			case face is
				when TOP =>
					iterate (assy_doc.top.lines, write_line'access);
					iterate (assy_doc.top.arcs, write_arc'access);
					iterate (assy_doc.top.circles, write_circle'access);

				when BOTTOM =>
					iterate (assy_doc.bottom.lines, write_line'access);
					iterate (assy_doc.bottom.arcs, write_arc'access);
					iterate (assy_doc.bottom.circles, write_circle'access);
			end case;					
		end query_module;
	...
	begin
		log (text => "module " & to_string (module_cursor)
			 & " write assy doc lines, arcs and circles",
			 level => log_threshold);
