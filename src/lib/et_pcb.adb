...
package body et_pcb is
	...
	begin -- get_probe_line_intersections		
		log (text => "computing intersections with board outline ...",
			 level => log_threshold);

		log_indentation_up;

		result := in_polygon_status (outline, point);
	...
	begin -- get_probe_line_intersections		
		log (text => "computing intersections with holes ...",
			 level => log_threshold);

		log_indentation_up;

		-- Get intersections with holes and merge them with result:
		iterate (holes, query_hole'access);		
	...
	begin -- get_probe_line_intersections
		...
		-- Get intersections with fill area:
		result := in_polygon_status (area, point);
	...
	begin -- get_probe_line_intersections
		log (text => "computing intersections with global cutout areas ...",
			 level => log_threshold);
