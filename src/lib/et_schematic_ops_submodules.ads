...
package et_schematic_ops_submodules is
	...
	procedure submodule_not_found (
		name : in et_module_instance.type_module_instance_name);
	...
	function submodule_port_exists (
		...
		port			: in et_net_names.type_net_name;
		direction		: in type_netchanger_port_name) -- master/slave
		return boolean;
	...
	function submodule_port_exists (
		...
		submod_instance : in et_module_instance.type_module_instance_name; -- MOT_DRV_3
	...
	function get_submodule_port_position (
		...
		submod_name		: in et_module_instance.type_module_instance_name; -- MOT_DRV_3
		port_name		: in et_net_names.type_net_name; -- RESET
	...
	procedure insert_port (
		...
		instance		: in et_module_instance.type_module_instance_name; -- OSC
	...
	procedure add_port (
		module_name		: in type_module_name; -- motor_driver (without extension *.mod)
		instance		: in et_module_instance.type_module_instance_name; -- OSC1
	...
	procedure delete_ports (
		...
		instance		: in et_module_instance.type_module_instance_name;
	...
	procedure copy_submodule (
		module_name		: in type_module_name; -- the parent module like motor_driver (without extension *.mod)
		instance_origin	: in et_module_instance.type_module_instance_name; -- OSC1
		instance_new	: in et_module_instance.type_module_instance_name; -- CLOCK_GENERATOR
	...
	procedure rename_submodule (
		module_name		: in type_module_name; -- the parent module like motor_driver (without extension *.mod)
		instance_old	: in et_module_instance.type_module_instance_name; -- OSC1
		instance_new	: in et_module_instance.type_module_instance_name; -- CLOCK_GENERATOR
		commit_design	: in type_commit_design := DO_COMMIT;
		log_threshold	: in type_log_level);
	...
	function get_alternative_submodule (
		...
		variant	: in et_assembly_variant_name.type_assembly_variant_name; -- low_cost
		submod	: in et_module_instance.type_module_instance_name) -- OSC1
