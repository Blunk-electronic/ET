...
package body et_module_write_stencil is
	...
	is
		...
		begin
			case face is
				when TOP =>
					iterate (stencil.top.lines, write_line'access);
					iterate (stencil.top.arcs, write_arc'access);
					iterate (stencil.top.circles, write_circle'access);
