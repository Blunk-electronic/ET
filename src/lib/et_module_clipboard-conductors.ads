...
package et_module_clipboard.conductors is
...
-- COPY:
	...
	-- This procedure copies selected conductor
...
-- PASTE:
	...
	-- This procedure copies conductor objects
	-- from the clipboard to the given module.
	-- The objects will be placed by the given offset:
